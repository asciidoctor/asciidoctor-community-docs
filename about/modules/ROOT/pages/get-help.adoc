...
Please do not comment on closed issues unless you're reporting whether the fix worked for you.
Also, if you post an unproductive comment on an open issue, such as "`What's the status of this issue after X years?`", your comment will be deleted.
