...
As you enter your query, the search results will be displayed immediately below the search box.
...
You can also press kbd:[Enter] when the result is highlighted with the light blue selection box.
